...
@section('title') Delivered Order @endsection

@section('orders') active show-sub @endsection

@section('Delivered Order') active @endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Delivered Order</li>
    </ol>
</nav>
@endsection
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">Delivered Order</div>
