...
@section('title') Shipped Order @endsection

@section('orders') active show-sub @endsection

@section('Shipped Order') active @endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Shipped Order</li>
    </ol>
</nav>
@endsection
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">Shipped Order</div>
